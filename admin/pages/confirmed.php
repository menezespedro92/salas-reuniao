...
<div class="header-line">
  <div class="container">
	<h3><?php echo $this->texts["confirmed_bookings"];?></h3>
  </div>
</div>
...
<div class="container">
	...
	<div class="col-md-3 pull-right no-right-padding">
		<div class="db-wrap"  onclick="javascript:LoadPage('add')" onmouseover="javascript:OverDB(this, 7)" onmouseout="javascript:OutDB(this)">
			
			<a href="index.php?page=bookings">
				<img src="images/arrow.png" class="pull-left arrow-img"/>
				<h4 class="no-margin pull-left"><?php echo $this->texts["new_bookings"];?></h4>
			...
			<div class="back-color-7" style="position:absolute;bottom:0px;left:0px;width:100%;height:7px"></div>
		</div>
	</div>
	...
	<div class="table-responsive table-wrap">
	  ...
	  <?php
		...
		{
			$i++;
			if($booking->status!=1) continue;
			?>
			<tr>
				<td>
					<a href="index.php?page=confirmed&proceed_delete=<?php echo $booking->code;?>"><img src="images/delete.png" alt="Delete Booking"/></a>
				</td>
				<td>
