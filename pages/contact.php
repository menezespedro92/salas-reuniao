	...
	<fieldset>
		...
		<ol>
			...
			<li>
				...
				<input id="email" <?php if(isset($_REQUEST["email"])) echo "value=\"".$_REQUEST["email"]."\"";?> name="email" placeholder="exemplo@dominio.com" type="email" required/>
				
			</li>
			<li>
				<label for="phone"><?php echo $this->texts["phone"];?></label>
				<input id="phone" <?php if(isset($_REQUEST["phone"])) echo "value=\"".$_REQUEST["phone"]."\"";?> name="phone" placeholder="(DDD) xxxxx-xxxxx" type="text"/>
			</li>
			<?php
